...
def init_app(database_connection):
    global conn
...
@routes.route("/create_portfolio", methods=["POST"])
...
@routes.route("/portfolio/<int:portfolio_id>")
...
@routes.route("/add_stock_to_portfolio", methods=["POST"])
